    ...
    <section className="myContainer">
      <div className="socialMediaBg">
        <div className="row align-items-center">
          ...
          <div className="d-none d-md-block col-md-3 col-lg-4 text-center">
            <p>Call Us Today!</p>
            <h3>+012345-67900</h3>
          </div>
      ...
      <div className="mt-3 mb-5 pb-4 pb-lg-0 text-center">
        <p>
          Copyright 2022 @{' '}
          <a
            href="https://www.github.com/Cypher1998"
            target="_blank"
            rel="noreferrer"
          >
            <span className="footerColText">Cypher</span>
          </a>
          , All rights reserved.
        </p>
      </div>
