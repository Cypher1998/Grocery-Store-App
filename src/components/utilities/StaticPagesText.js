export const aboutTextOne =
    'Holisticly seize parallel metrics and functional ROI. Seamlessly revolutionize error-free internal or "organic" sources before effective scenarios. Progressively incentivize state of the art applications for efficient intellectual capital.',
  aboutTextTwo =
  ...
  aboutTextFour =
    'Appropriately visualize market-driven data before one-to-one scenarios. Collaboratively productize multifunctional ROI through intuitive supply chains. Enthusiastically seize revolutionary value and process-centric services. Competently harness intuitive information after interoperable markets. Interactively revolutionize future-proof value before granular sources. Dynamically embrace diverse customer service and installed base paradigms. Credibly seize enterprise-wide experiences for end-to-end data.';
export const contactTextOne =
  ...
  contactTextThree = 'Cecilia Chapman, 561-4535 Nulla LA, United States 96522',
  contactTextFour =
...
export const privacyTextOne =
  ...
  privacyTextFive =
    'Please note that the Company will not ask you to share any sensitive data or information via email or telephone. If you receive any such request by email or telephone, please do not respond/divulge any sensitive data or information.',
  privacyTextSix =
    'We use the information we collect in various ways, including to:',
  privacyTextSeven = [
    ' Provide, operate, and maintain our website, to provide you with updates and other information.',
    'Improve, personalize, and expand our website,and other information relating to the website.',
    'Understand and analyze how you use our website, to provide you with updates and other information relating to the website.',
  ...
  privacyTextEight =
    "You may consult this list to find the Privacy Policy for each of the advertising partners of KachaBazar. Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on KachaBazar, which are sent directly to users' browser. Note that KachaBazar has no access to or control over these cookies that are used by third-party advertisers.",
  privacyTextNine =
...
export const termsTextOne =
  ...
  termsTextTwoA =
    "We employ the use of cookies. By accessing KachaBazar, you agreed to use cookies in agreement with the KachaBazar's Privacy Policy.",
  termsTextThree =
...
export const quesOne = 'How does the kachabaza work?',
  ansOne =
    'Holisticly engage sticky niche markets before collaborative collaboration and idea-sharing. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.',
  quesTwo = 'Can I cancel my subscription anytime?',
  ansTwo =
  ...
  quesThree = 'Which payment method do we accept?',
  ansThree =
    'Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.',
  quesFour = 'What are the benefits of using kachabazar?',
  ansFour =
    'Distinctively initiate error-free channels with highly efficient ROI. Intrinsicly envisioneer world-class data via best-of-breed best practices. Efficiently enable empowered e-tailers after cross-unit services. Uniquely expedite seamless e-tailers via cooperative interfaces. Monotonectally myocardinate customer directed meta-services whereas error-free scenarios.',
  quesFive = 'What is kachabazar EC2 auto scaling?',
  ansFive =
    'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit ducimus temporibus, tempora laborum numquam impedit fuga quam distinctio minus veniam. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Soluta.';
